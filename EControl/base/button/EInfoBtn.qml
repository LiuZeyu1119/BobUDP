...
Button{
    ...
    property var cusStyle: EInfoBtn.BtnStyle.Default
    ...
    background: Rectangle{
        ...
        anchors.fill: parent
        radius: 4
        border.width:cusStyle === EInfoBtn.BtnStyle.Default ? 0 :1
    ...
    function getBgColor(){
        ...
        case EInfoBtn.BtnStyle.Default:
            if(rootBut.pressed){
