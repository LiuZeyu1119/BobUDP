...
Button{
    ...
    property var cusStyle: EWarningBtn.BtnStyle.Default
    ...
    background: Rectangle{
        ...
        anchors.fill: parent
        radius: 4
        border.width:cusStyle === EWarningBtn.BtnStyle.Default ? 0 :1
    ...
    function getBgColor(){
        ...
        case EWarningBtn.BtnStyle.Default:
            if(rootBut.pressed){
        ...
        case EWarningBtn.BtnStyle.Simple:
            if(rootBut.pressed){
                return EColor.stateColor(EColor.Warning_1)
            }
            else if( bgRect.pressedState && rootBut.released){
